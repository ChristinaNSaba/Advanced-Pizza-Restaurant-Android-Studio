...
public class AdminProfileActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void saveUserInfo() {
        ...
        } else if (TextUtils.isEmpty(currentUser.getProfilePicture())) {
            currentUser.setProfilePicture(""); // Set profile picture to empty string or null
        }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.adminprofile) {
            Intent welcomeIntent = new Intent(AdminProfileActivity.this, AdminProfileActivity.class);
            startActivity(welcomeIntent);
        } else if (id == R.id.addadmin) {
            Intent menu = new Intent(AdminProfileActivity.this, AddAdminActivity.class);
            startActivity(menu);
        } else if (id == R.id.addspecialoffers) {
            Intent favorites = new Intent(AdminProfileActivity.this, AdminAddSpecialOffersActivity.class);
            startActivity(favorites);
        } else if (id == R.id.viewallorders) {
            Intent orders = new Intent(AdminProfileActivity.this, AdminViewAllOrderActivity.class);
